...
echo "*** uBlock🦆.mv3: Creating extension"

DES="dist/build/uBlock🦆.mv3"
...
echo "*** uBlock🦆.mv3: Copying common files"
...
echo "*** uBlock🦆.mv3: Copying mv3-specific files"
...
if [ "$1" != "quick" ]; then
    echo "*** uBlock🦆.mv3: Generating rulesets"
    TMPDIR=$(mktemp -d)
    mkdir -p $TMPDIR
...
echo "*** uBlock🦆.mv3: extension ready"
